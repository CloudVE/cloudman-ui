...
import {MaterialElevationDirective} from "../shared/layouts/material-elevation.directive";
...
@NgModule({
  ...
  declarations: [ChartManagementComponent, CreateProjectDlgComponent, AddChartDlgComponent,
                 ChartReconfigurationDlgComponent, InlineEditComponent, SafePipe, MaterialElevationDirective],
